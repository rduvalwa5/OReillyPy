...
class TestAddresses(unittest.TestCase): 
        ...
        def test_state(self): 
           ...
           self.assertRaises(StateError, setattr, self.home, 'state', 'BB')        
           self.home.state = 'CO' 
        ...
        def test_zip_code(self): 
           ...
           self.assertRaises(ZipCodeError, setattr, self.home, 'zip_code', '12345A')   
           self.assertRaises(ZipCodeError, setattr, self.home, 'zip_code', 'A12345')   
