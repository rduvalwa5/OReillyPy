...
expd = "Have you ever noticed, in television and movies, that phone numbers and credit cards are obviously fake numbers like 555-123-4567 or XXXX-XXXX-XXXX-5555? It is because a number that appears to be real, such as XXXX-XXXX-XXXX-5678, triggers the attention of privacy and security experts." 
...
class TestCcnSafetyRegex(unittest.TestCase):
    ...
    def test_altered_ccn(self):
        self.assertIsNotNone(re.search("X{4}-X{4}-X{4}-\d{4}", result), "Credit Card Number not changed")    
    """
